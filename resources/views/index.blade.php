...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3_agile_logo">
			<h1><a href="index.html"><span>c</span>ounty<i>Suistanance for everybody</i></a></h1>
		</div>
		...
		<div class="agileits_w3layouts_menu">
			<div class="shy-menu">
				...
				<div class="shy-menu-panel">
					<nav class="menu menu--horatio link-effect-8" id="link-effect-6">
	...
	<div class="w3_banner_info">
		<div class="w3_banner_info_grid">
			...
			<p> working together does not only bring sustainance  but alo love, trust and an everlasting bond.
				together we can eliminate hunger once and for all. Together we can Develop</p>
			<ul>
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<img src="{{url('/images/4.jpg')}}" alt="this didnt work" class="img-responsive" />
			...
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						<h4>Workers Training</h4>
						<p>All our workers receive basic agricultural training once they start working with us.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
			...
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						...
						<p>All our schemes are managed and supervised by proffesionals.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
		...
		<div class="col-md-4 agileits_banner_bottom_left2">
			<div class="agileinfo_banner_bottom_pos">
				<div class="w3_agileits_banner_bottom_pos_grid">
					...
					<div class="col-xs-8 wthree_banner_bottom_grid_right">
						<h4>Free Helpline</h4>
						<p>For more information or any query along the way kindly contact us.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
...
<!-- welcome -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">The future of Our <span>Plantation</span></h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive" />
			</div>
			<p class="agile_para">Below are some of the plants that will be planting in the forseable future</p>
		</div>
...
<!-- welcome-bottom -->
	<div id="welcome_bottom" class="welcome-bottom">
		<div class="col-md-6 wthree_welcome_bottom_left">
			<h3>we work hard and make our county <span>greenery</span></h3>
			<p>some of the statisitics that are produced from the several schems that are ongoig are as below.</p>
			...
			<div class="agileinfo_grid">
				<figure class="agileits_effect_moses">
					...
					<figcaption>
						...
						<p>let us strugle today for a better life tomorrow
						Govener.</p>
					</figcaption>
				</figure>
			</div>
...
<!-- news -->
	<div class="welcome">
		<div class="container">
			<h3 class="agileits_w3layouts_head">Our current <span>Ongoing</span> Schemes</h3>
			<div class="w3_agile_image">
				<img src="images/1.png" alt=" " class="img-responsive">
			</div>
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						...
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>maize scheme</h3></div>
						</div>
					</div>
					<div class="agileits_w3layouts_news_grid">
						<ul>
							<li><i class="fa fa-calendar" aria-hidden="true"></i>25 January 2019</li>
							<li><i class="fa fa-user" aria-hidden="true"></i><a href="#">Admin</a></li>
						</ul>
						<h4><a href="#" data-toggle="modal" data-target="#myModal">Maize Scheme</a></h4>
						<p>The maize scheme will cover half an acre of land over a period of 6 months starting from january 2019 running to june 2019. this program will benefit around 10,000 citizens</p>
					</div>
				</div>
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						...
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>Beans Scheme</h3></div>
						</div>
					</div>
					<div class="agileits_w3layouts_news_grid">
						<ul>
							<li><i class="fa fa-calendar" aria-hidden="true"></i>28 January 2019</li>
							<li><i class="fa fa-user" aria-hidden="true"></i><a href="#">Admin</a></li>
						</ul>
						<h4><a href="#" data-toggle="modal" data-target="#myModal">Beans Scheme</a></h4>
						<p>The Beans scheme will cover half an acre of land over a period of 6 months starting from january 2019 running to june 2019. this program will benefit around 10,000 citizens</p>
					</div>
				</div>
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						...
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>Coming Soon</h3></div>
						</div>
					</div>
					<div class="agileits_w3layouts_news_grid">
						<ul>
							<li><i class="fa fa-calendar" aria-hidden="true"></i>30 August 2019</li>
							<li><i class="fa fa-user" aria-hidden="true"></i><a href="#">Admin</a></li>
						</ul>
						<h4><a href="#" data-toggle="modal" data-target="#myModal">Wheat Scheme</a></h4>
						<p>The maize scheme will cover half an acre of land over a period of 6 months starting from february 2020 running to july 2020. this program will benefit around 10,000 citizens</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<!-- newsletter -->
	<div class="newsletter">
		<div class="container">
			...
			<p class="agile_para agileits_para">Get the latest news on the plantation and the schemes that it comes up with.</p>
...
<!-- footer -->
	<div class="footer">
			...
			<div class="w3agile_footer_grids">
				<div class="col-md-3 agileinfo_footer_grid">
					<div class="agileits_w3layouts_footer_logo">
						<h2><a href="index.html"><span>C</span>ounty<i>Grow healthy products</i></a></h2>
					</div>
				</div>
				<div class="col-md-4 agileinfo_footer_grid">
					<h3>Contact Info</h3>
					<h4>Call Us <span>+254 795 291 708</span></h4>
					<p>My Company, 101 Mai Mahiu Road <span>Ole sangale campus.</span></p>
					<ul class="agileits_social_list">
						<li><a href="#" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#" class="agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						<li><a href="#" class="w3_agile_dribble"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
		...
		<div class="w3_agileits_footer_copy">
			<div class="container">
				<p>© 2019 County. All rights reserved | Design by <a href="http://www.strathmoreuniversity.com">Strathmore University.</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
